...
echo Compiling Arduino Uno v1.1 sketch...
"%ARDUINO_CLI%" compile -b arduino:avr:uno arduino\tictactoe_arm_serial_v1_1
if errorlevel 1 goto error

echo Uploading v1.1 to Arduino Uno on COM3...
"%ARDUINO_CLI%" upload -p COM3 -b arduino:avr:uno arduino\tictactoe_arm_serial_v1_1
if errorlevel 1 goto error

echo v1.1 upload complete.
goto end
