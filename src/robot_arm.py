...
from calibration import CellPose, pose_summary
...
class MockRobotArm:
    ...
    def touch_cell(
        ...
        lines = [
            ...
            "sequence: home -> approach -> touch -> approach -> home",
        ]
...
class ArduinoSerialRobotArm:
    ...
    def touch_cell(
        ...
        sequence = [
            ("home", self.home_pose),
            ("approach", pose.approach_pose),
            ("touch", pose.touch_pose),
            ("approach", pose.approach_pose),
            ("home", self.home_pose),
        ]
